        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
              <p>
                <strong className="text-foreground">Sam sebe agronom</strong> — аграрная компания, 
                основанная в 2019 году. Мы выращиваем овощи на собственных землях 
                Кабардино-Балкарской республики. За годы работы мы накопили экспертизу 
                в области агротехнологий, подбора семян и удобрений.
              </p>
              <p>
                Наша цель — обеспечить стабильные поставки качественных овощей 
                и развивать культуру ответственного земледелия.
              </p>
              <p>
                Мы гордимся самостоятельным подходом к делу — от планирования 
                посадок до сбора урожая и логистики поставок.
              </p>
            </div>
